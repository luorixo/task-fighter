    ...
    return {
      ...
      particles: {
        ...
        shape: {
          type: 'image',
          image: {
            src: "https://github.com/luorixo/portfolio/blob/main/client/src/assets/Images/rain.png?raw=true",
            width: 20,
            height: 45,
          }
        },
        ...
        move: {
          ...
          straight: true,
          out_mode: 'out',
          speed: { min: 20, max: 25 }, // using a range in speed value will make particles move in a random speed between min/max values, each particles have its own value, it won't change in time by default
        },
        opacity: {
